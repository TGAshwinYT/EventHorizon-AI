...
const MobileSkillsDashboard = ({ onBack, courses, headerText, labels }: SkillsDashboardProps) => {
    ...
    const renderCourseDetail = (course: Course) => (
        <div className="flex flex-col h-full animate-fade-in">
            ...
            <div className="flex-1 overflow-y-auto pr-4 custom-scrollbar">
                <div className="glass-panel p-5 rounded-2xl border-blue-500/20 bg-blue-500/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            {courses.length > 0 ? (
                                courses.map((course, index) => (
                                    <div
                                        key={index}
                                        className="glass-panel p-4 rounded-2xl border-white/5 bg-white/5 hover:bg-white/10 transition-all duration-300 group flex flex-col h-full"
                                    >
                                        ...
                                        <h3 className="text-lg font-bold mb-1 group-hover:text-blue-400 transition-colors">{course.name}</h3>
                                        <p className="text-gray-400 text-xs mb-4 flex-1 line-clamp-2">{course.description}</p>
...
export default MobileSkillsDashboard;
